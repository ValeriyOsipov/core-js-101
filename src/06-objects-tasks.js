...
const cssSelectorBuilder = {
  ...
  element(value) {
    ...
    newSelector.weigth = 1;
    this.checkRepeat(newSelector.weigth);
    this.checkOrder(newSelector.weigth);
    return newSelector;
  },
